...
#correlation between importance of attractiveness versus perceived attractiveness by the person
...
#correlation between importance of intelligence versus perceived intelligence by the person

intel_corr<-lm(intel1_1~intel, data=yesdataimp)
summary(intel_corr)

#correlation between importance of being fun versus perceived 'fun-ness' by the person

fun_corr<-lm(fun1_1~fun, data=yesdataimp)
summary(fun_corr)

#correlation between importance of ambition versus perceived ambition by the person

amb_corr<-lm(amb1_1~amb, data=yesdataimp)
summary(amb_corr)

#correlation between importance of shared interests versus perceived shared interests by the person
